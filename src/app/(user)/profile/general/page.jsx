...
const HeaderBreadcrumbs = dynamic(() => import('src/components/headerBreadcrumbs'), { loading: () => <Breadcrumbs /> });

// Meta information
export const metadata = { title: 'BuyHalal', applicationName: 'BuyHalal', authors: 'BuyHalal' };
